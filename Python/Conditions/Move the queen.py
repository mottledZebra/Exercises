...
# Chess Queen may move diagonally, horizontally or vertically.
# Given two different squares of the chessboard, determine
# whether a Queen to get from the first cell to the second one.
...
# if cell from the first move of the Queen can get to the second
# or NO otherwise.
...
print('может ли ферзь попасть с первой клетки на вторую одним ходом.')
...
print('если из первой клетки ходом ферзя можно попасть во вторую')
